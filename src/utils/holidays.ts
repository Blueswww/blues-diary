...
const holidays2026: Holiday[] = [
  ...
  // 端午节
  { date: '2026-06-25', name: '端午节', type: 'holiday' },
  { date: '2026-06-26', name: '端午节', type: 'holiday' },
  { date: '2026-06-27', name: '端午节', type: 'holiday' },
  // 中秋节 & 国庆节
  ...
  { date: '2026-10-06', name: '中秋节', type: 'holiday' },
  { date: '2026-10-07', name: '中秋节', type: 'holiday' },
  { date: '2026-10-08', name: '国庆节', type: 'holiday' },
]

// 常见纪念日
const commonAnniversaries: { month: number; day: number; name: string }[] = [
